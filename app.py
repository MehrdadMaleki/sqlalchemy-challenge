...
def home():
    return (f"Available routes<br/>"
            f"/api/v1.0/precipitation : The list of dates and precipitation<br/>"
            f"/api/v1.0/stations : The list of stations from dataset<br/>"
            f"/api/v1.0/tobs : The list of he dates and temperature observations of the most active station for the last year of data<br/>"
            f"/api/v1.0/startdate : list of the minimum temperature, the average temperature, and the max temperature for a given start or start-end range<br/>"
